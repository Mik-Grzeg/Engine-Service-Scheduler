    ...
    def test_create_invalid_email(self):
        with self.assertRaises(ValidationError):
            self.user.objects.create_user(email='', password=self.password,
                                          first_name=self.first_name, last_name=self.last_name,
                                          work_phone=self.work_phone)
            self.user.objects.create_user(email='emailaddress', password=self.password,
                                          first_name=self.first_name, last_name=self.last_name,
                                          work_phone=self.work_phone)
            self.user.objects.create_user(email='email@@mail.com', password=self.password,
                                          first_name=self.first_name, last_name=self.last_name,
                                          work_phone=self.work_phone)
            self.user.objects.create_user(email='email@mail', password=self.password,
                                          first_name=self.first_name, last_name=self.last_name,
                                          work_phone=self.work_phone)
